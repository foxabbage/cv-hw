...
def run_experiment(config):
    ...
    swanlab.init(project="pet_dataset_vit", config=config,
                experiment_name=f"lr_base_{config['lr_base']}_lr_head_{config['lr_head']}")
    c = config
    ...
    for name, param in model.named_parameters():
        is_head = any(k in name for k in ['fc.', 'head.', 'classifier.'])
        lr = c['lr_head'] if is_head else c['lr_base']
    ...
    save_name = f"./models/vit/vit_best_model_lr_base_{c['lr_base']}_lr_head_{c['lr_head']}.pth"
